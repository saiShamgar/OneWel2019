...
public class MatrimonyInsertionData implements Serializable {
    ...
    String gender;
    String age;
    String height_in_feet,height_in_inch;
    String marital_status,religion,mother_tongue,caste_division,physical_staus;
    ...
    public void setHeight_in_feet(String height_in_feet) {
        this.height_in_feet = height_in_feet;
    }

    public String getHeight_in_inch() {
        return height_in_inch;
    }

    public void setHeight_in_inch(String height_in_inch) {
        this.height_in_inch = height_in_inch;
    }
    ...
    public String getCaste_division() {
        return caste_division;
    }

    public void setCaste_division(String caste_division) {
        this.caste_division = caste_division;
    }

    public String getPhysical_staus() {
        return physical_staus;
    }

    public void setPhysical_staus(String physical_staus) {
        this.physical_staus = physical_staus;
    }
